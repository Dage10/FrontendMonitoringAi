...
import { toChartData, avgLatency, availabilityPercent, RANGE_OPTIONS, filterMetricsByMinutes } from "@/lib/metrics";
...
function RangeSelector({ value, onChange }: { value: number; onChange: (minutes: number) => void }) {
  return (
