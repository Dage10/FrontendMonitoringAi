...
export default function CreateService(){
    ...
    const submit = async() => {
        ...
        setSubmitting(true)
        try {
            await api("/services", { method: "POST", body: JSON.stringify({ name,url }) });
    ...
    return (
        ...
        <Link href="/services"
        className="w-10 h-10 absolute top-10 left-4 cursor-pointer bg-[#6366F1] p-2 rounded-full text-[#F8FAFC]"
        >
        ...
        <div className="flex">
            <div className="flex flex-col w-full px-10 lg:px-8 xl:px-8 pt-24 pb-10 lg:pb-8 xl:pb-8 gap-8 max-w-7xl mx-auto">

                <div className="bg-[#334155] p-8 rounded-xl w-full max-w-md mx-auto shadow-[0_4px_24px_rgba(0,0,0,0.25)]">
                    <p className="text-2xl font-semibold mb-6 text-center">Create service</p>
